...
public class CreateGoalDTO {
    ...
    @NotNull(message = "O valor alvo da meta é obrigatório")
    @Positive(message = "O valor alvo da meta deve ser maior que zero")
    ...
    public Goal toDomain() {
        return new ModelMapper().map(CreateGoalDTO.class, Goal.class);
    }
}
